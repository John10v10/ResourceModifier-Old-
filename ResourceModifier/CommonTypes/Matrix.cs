...
namespace ResourceModifier.CommonTypes
{
    ...
    public unsafe struct Matrix : ISerializable
    {
        ...
        {
            float cosx = (float)Math.Cos(x * (float)(180.0 / Math.PI));
            float sinx = (float)Math.Sin(x * (float)(180.0 / Math.PI));
            float cosy = (float)Math.Cos(y * (float)(180.0 / Math.PI));
            float siny = (float)Math.Sin(y * (float)(180.0 / Math.PI));
            float cosz = (float)Math.Cos(z * (float)(180.0 / Math.PI));
            float sinz = (float)Math.Sin(z * (float)(180.0 / Math.PI));
        ...
        public Vector3 GetAngles()
        {
            ...
            fixed (float* p = _values)
            {
                ...
                if ((Math.PI/2) - Math.Abs(y) < 0.0001f)
                {
            ...
            return new Vector3(x, y, z) * (float)(Math.PI / 180.0);
        }
        ...
        public static Matrix TransformMatrix(Vector3 scale, Vector3 rotate, Vector3 translate)
        {
            ...
            float cosx = (float)Math.Cos(rotate._x * (float)(180 / Math.PI));
            float sinx = (float) Math.Sin(rotate._x * (float)(180 / Math.PI));
            float cosy = (float) Math.Cos(rotate._y * (float)(180 / Math.PI));
            float siny = (float) Math.Sin(rotate._y * (float)(180 / Math.PI));
            float cosz = (float) Math.Cos(rotate._z * (float)(180 / Math.PI));
            float sinz = (float) Math.Sin(rotate._z * (float)(180 / Math.PI));
        ...
        {
            float cosx = (float) Math.Cos(rotation._x * (float)(180 / Math.PI));
            float sinx = (float) Math.Sin(rotation._x * (float)(180 / Math.PI));
            float cosy = (float) Math.Cos(rotation._y * (float)(180 / Math.PI));
            float siny = (float) Math.Sin(rotation._y * (float)(180 / Math.PI));
            float cosz = (float) Math.Cos(rotation._z * (float)(180 / Math.PI));
            float sinz = (float) Math.Sin(rotation._z * (float)(180 / Math.PI));
        ...
        {
            Vector3 up = new Vector3(-(float) Math.Sin(roll * (180.0/Math.PI)),
                (float) Math.Cos(roll * (180.0 / Math.PI)), 0);
